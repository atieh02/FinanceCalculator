function calcCard(){
 ...
 const C=window.CMFChart&&CMFChart.colors;if(C)CMFChart.donut(document.getElementById('card-chart'),complete?[{label:'Balance paid',value:balance,color:C.brand},{label:'Interest paid',value:interest,color:C.coral}]:[]);
