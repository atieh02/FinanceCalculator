function calcLoan(){
 ...
 const C=window.CMFChart&&CMFChart.colors;if(C)CMFChart.donut(document.getElementById('loan-chart'),complete?[{label:'Principal',value:amount,color:C.brand},{label:'Interest',value:interest,color:C.coral}]:[]);
